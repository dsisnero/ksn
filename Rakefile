...
Hoe.spec 'ksn' do
  ...
  dependency('vcr', '> 0.0.0', :dev)
  dependency('webmock', '> 0.0.0', :dev)
  dependency('mechanize', '> 0.0.0', :dev)
  dependency('guard', '> 0.0.0', :dev)
  dependency('guard-rspec', '> 0.0.0', :dev)
  ...
  # self.rubyforge_name = 'ksn' # if different than 'ksn'
end
